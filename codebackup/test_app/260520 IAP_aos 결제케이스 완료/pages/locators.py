...
class IOS_MyLocators:
    ...
    #CHARGE_TIER_FIRST       = (AppiumBy.IOS_CLASS_CHAIN, '**/XCUIElementTypeStaticText[`name == "₩1,200"`]')
    #CHARGE_BTN             
    #SANDBOX_POPUP           = (AppiumBy.NAME, 'Sand Box')
    #SANDBOX_PW_INPUT_BOX    = (AppiumBy.IOS_CLASS_CHAIN, '**/XCUIElementTypeSecureTextField[`value == "암호"`]')
    #SANDBOX_CHECK_BTN       = (AppiumBy.NAME, '확인')
    #CHARGE_COMPLETE_POPUP   = (AppiumBy.NAME, '설정 완료')
    #CHARGE_COMPLETE_CHECK   