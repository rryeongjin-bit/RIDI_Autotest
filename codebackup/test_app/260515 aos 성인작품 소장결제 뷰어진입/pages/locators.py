...
class AOS_ContentshomeLocators:
    ...
    RENT_OWNERSHIP_LABEL = (AppiumBy.ID, 'ownershipLabel')
    ...
    ALL_CONTENTS_EPISODE_ITEM = (AppiumBy.XPATH,
    ...
    ADULT_CONTENTS_EPISODE_ITEM = (AppiumBy.XPATH,
    '(//android.view.ViewGroup[@resource-id="downloadButton"])[1]/preceding-sibling::android.view.ViewGroup[.//android.widget.TextView[@resource-id="ownershipLabel" and @text="소장"]][1]')
