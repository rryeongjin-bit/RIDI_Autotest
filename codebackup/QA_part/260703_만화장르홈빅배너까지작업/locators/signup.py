...
class AOS_SignUpLocators:
    ...
    AGREE_CHECK         = (AppiumBy.XPATH, '//android.widget.TextView[@text="이용약관, 개인정보 수집 및 이용에 동의해주세요."]')
...
class IOS_SignUpLocators:
    ...
    AGREE_CHECK         = (AppiumBy.IOS_CLASS_CHAIN, '**/XCUIElementTypeStaticText[`name == "이용약관, 개인정보 수집 및 이용에 동의해주세요."`]')
