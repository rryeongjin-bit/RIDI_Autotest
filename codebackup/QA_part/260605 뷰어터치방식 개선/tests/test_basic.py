...
class TestContentsHome_AllAges:
    ...
    def test_App_Checklist_177_다운로드아이콘(self):
        ...
        # 다운로드 후 뷰어 자동 진입 여부 체크
        TestContentsHome_AllAges.viewer_auto_entered = self.viewer.is_all_viewer_displayed()
...
class TestContentsHome_Adult:
    ...
    def test_App_Checklist_177_다운로드아이콘(self):
        ...
        # 다운로드 후 뷰어 자동 진입 여부 체크
        TestContentsHome_Adult.viewer_auto_entered = self.viewer.is_adult_viewer_displayed()
