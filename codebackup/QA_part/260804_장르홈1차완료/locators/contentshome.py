...
class AOS_ContentshomeLocators:
    #작품홈 상단영역
    ALL_CONTENTS_TITLE      = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().text("바다새와 늑대")')
    ADULT_CONTENTS_TITLE    = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().textContains("여리여리")')
    CART_CONTENTS_TITLE     = (AppiumBy.ANDROID_UIAUTOMATOR,  'new UiSelector().text("열혈강호")')
    ...
    SELECTBUY_CART_TITLE      = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().text("열혈강호 총 95권")')
    ...
    ALL_CONTENTS_THUMBNAIL_FIRST  = (AppiumBy.XPATH, '//android.view.ViewGroup[@content-desc="0바다새와 늑대 1화, 0바다새와 늑대 1화, 2025.02.10, 21.4MB"]/android.view.ViewGroup')
    ALL_CONTENTS_THUMBNAIL_SECOND = (AppiumBy.XPATH, '//android.view.ViewGroup[@content-desc="0바다새와 늑대 2화, 0바다새와 늑대 2화, 2025.02.10, 56MB"]/android.view.ViewGroup')
    EPISODE_TITLE_BEFORE_DOWNLOAD = (AppiumBy.XPATH, '(//android.view.ViewGroup[@resource-id="downloadButton"])[1]/preceding-sibling::android.view.ViewGroup[not(@resource-id="downloadButton") and @content-desc][1]/android.widget.TextView[1]')
    ...
    SELECTBUY_CART_RENT_ITEM        = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().description("열혈강호 1권, 열혈강호 1권, 2012.08.28, 200쪽, 156.3MB, 대여 800원, 소장 2,000원")')
    SELECTBUY_CART_OWN_ITEM         = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().description("열혈강호 1권, 열혈강호 1권, 2012.08.28, 200쪽, 156.3MB, 대여 800원, 소장 2,000원")')
    SELECTBUY_CART_OWN_LAST_ITEM    = (AppiumBy.XPATH, '//android.view.ViewGroup[contains(@content-desc, "열혈강호") and contains(@content-desc, "대여 800원, 소장 2,800원")]')
...
class IOS_ContentshomeLocators:
    #작품홈 상단영역
    ALL_CONTENTS_TITLE      = (AppiumBy.NAME, '바다새와 늑대')
    ADULT_CONTENTS_TITLE    = (AppiumBy.NAME, '여리여리')
    CART_CONTENTS_TITLE     = (AppiumBy.NAME, '열혈강호')
    ...
    SELECTBUY_CART_TITLE    = (AppiumBy.IOS_CLASS_CHAIN, '**/XCUIElementTypeStaticText[`name == "열혈강호 총 95권"`]')
    ...
    ALL_CONTENTS_THUMBNAIL_FIRST    = (AppiumBy.XPATH, '(//XCUIElementTypeOther[@name="바다새와 늑대 1화 2025.02.10, 21.4MB"])[3]')
    ALL_CONTENTS_THUMBNAIL_SECOND   = (AppiumBy.XPATH, '(//XCUIElementTypeOther[@name="바다새와 늑대 2화 2025.02.10, 56MB"])[3]')
    EPISODE_TITLE_BEFORE_DOWNLOAD   = (AppiumBy.XPATH, '(//XCUIElementTypeOther[@name="downloadButton"])[1]/../../XCUIElementTypeOther[@accessible="true"]')
    ...
    SELECTBUY_CART_RENT_ITEM     = (AppiumBy.XPATH, '(//XCUIElementTypeOther[@name="열혈강호 1권 2012.08.28, 200쪽, 156.3MB 대여 800원 소장 2,000원"])[3]')
    SELECTBUY_CART_OWN_ITEM      = (AppiumBy.XPATH, '(//XCUIElementTypeOther[@name="열혈강호 1권 2012.08.28, 200쪽, 156.3MB 대여 800원 소장 2,000원"])[6]')
    SELECTBUY_CART_OWN_LAST_ITEM = (AppiumBy.XPATH, '//XCUIElementTypeOther[@accessible="true" and @enabled="true"]')
