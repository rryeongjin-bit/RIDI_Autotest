...
class AOS_ContentshomeLocators:
    ...
    SELECTBUY_CART_RENT_ITEM        = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().description("0열혈강호 1권, 0열혈강호 1권, 2012.08.28, 200쪽, 156.3MB")')
    SELECTBUY_CART_OWN_ITEM         = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().description("열혈강호 1권, 열혈강호 1권, 2012.08.28, 200쪽, 156.3MB, 소장 2,000원 1,800원")')
    SELECTBUY_CART_OWN_LAST_ITEM    = (AppiumBy.XPATH, '//android.view.ViewGroup[contains(@content-desc, "열혈강호") and contains(@content-desc, " 대여 800원, 소장 2,800원 2,520원")]')
...
class IOS_ContentshomeLocators:
    ...
    SELECTBUY_CART_RENT_ITEM     = (AppiumBy.XPATH, '(//XCUIElementTypeOther[@name="열혈강호 1권 2012.08.28, 200쪽, 156.3MB"])[3]')
    SELECTBUY_CART_OWN_ITEM      = (AppiumBy.XPATH, '(//XCUIElementTypeOther[@name="열혈강호 1권 2012.08.28, 200쪽, 156.3MB 소장 2,000원 1,800원"])[3]')
